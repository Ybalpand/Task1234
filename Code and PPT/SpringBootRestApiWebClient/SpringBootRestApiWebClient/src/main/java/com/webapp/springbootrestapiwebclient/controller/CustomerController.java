...
import com.webapp.springbootrestapiwebclient.SpringBootRestApiWebClientApplication;
...
public class CustomerController {
	...
	private AccountService accountService;
		...
		public Customer getAccountByCustomerId(@RequestParam(name = "customerId", required = false) Integer customerId)
			...
			Customer customerInfo = SpringBootRestApiWebClientApplication.getCustomerInfoById(customerId);
		...
		public Customer getCustomerByAccountId(@RequestParam(name = "accountId", required = false) Integer accountId) {
			...
			Customer customers = SpringBootRestApiWebClientApplication.getCustomerInfoById(account.getCustomerId());
